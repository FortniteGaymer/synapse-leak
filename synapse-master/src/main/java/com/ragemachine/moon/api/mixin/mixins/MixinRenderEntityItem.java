...
import com.ragemachine.moon.impl.client.modules.render.ItemPhysics;
...
public abstract class MixinRenderEntityItem extends MixinRenderer<EntityItem>
{
    ...
    {
        if (MoonHack.getModuleManager.getModule(ItemPhysics.class).isEnabled())
        {
        ...
        if (MoonHack.getModuleManager.getModule(ItemPhysics.class).isEnabled())
        {
            ...
            for (int j = 0; j < i; ++j) {
                if (ibakedmodel.isAmbientOcclusion()) {
                    GlStateManager.pushMatrix();
                    GlStateManager.scale(MoonHack.getModuleManager.getModule(ItemPhysics.class).scaling.getValue(), MoonHack.getModuleManager.getModule(ItemPhysics.class).scaling.getValue(), MoonHack.getModuleManager.getModule(ItemPhysics.class).scaling.getValue());
