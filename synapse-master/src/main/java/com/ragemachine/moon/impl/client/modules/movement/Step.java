...
public class Step extends Module {
    ...
    public Value<Integer> stepHeight = addSetting(new Value("Height", 2, 1, 4));
    public Value<Boolean> spoof = addSetting(new Value("Spoof", true));
    public Value<Integer> ticks = addSetting(new Value("Delay", 3, 0, 25, v -> spoof.getValue(), "Amount of ticks you want to spoof."));
    public Value<Boolean> turnOff = addSetting(new Value("Disable", false));
    public Value<Boolean> small = addSetting(new Value("Offset", false, v -> stepHeight.getValue() > 1));
