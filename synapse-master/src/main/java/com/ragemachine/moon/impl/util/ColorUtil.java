...
public class ColorUtil {
    ...
    public static Color getClickGUIColor(){
        return new Color((int) ClickGui.getInstance().red.getValue(), ClickGui.getInstance().green.getValue(), ClickGui.getInstance().blue.getValue());
    }
    ...
    public static int changeAlpha(int origColor, int userInputedAlpha) {
        origColor = origColor & 0x00ffffff; //drop the previous pAlpha value
    ...
    public static Color rainbow(int delay) {
        ...
        rainbowState %= 360.0D;
        return Color.getHSBColor((float)(rainbowState / 360.0D),  com.ragemachine.moon.impl.client.modules.client.Colors.getInstance().rainbowSaturation.getValue() / 255.0F, com.ragemachine.moon.impl.client.modules.client.Colors.getInstance().rainbowBrightness.getValue() / 255.0F);
    }
