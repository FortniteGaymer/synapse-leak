...
public class Freecam extends Module {
    ...
    public Value<Double> speed = addSetting(new Value("Speed", 0.5, 0.1, 5.0)); //Weird rounding issues when this was a float...
    public Value<Boolean> view = addSetting(new Value("3D", false));
    public Value<Boolean> packet = addSetting(new Value("Packet", true));
    public Value<Boolean> disable = addSetting(new Value("Logout/Off", true));
