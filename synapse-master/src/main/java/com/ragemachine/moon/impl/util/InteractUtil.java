...
public class InteractUtil {
   ...
   public static void faceVectorPacketInstant(Vec3d var0) {
      ...
      Minecraft.getMinecraft().player.connection.sendPacket(new Rotation(var1[0], var1[1], Minecraft.getMinecraft().player.onGround));
   }
   ...
   private static void processRightClickBlock(BlockPos var0, EnumFacing var1, Vec3d var2) {
      getPlayerController().processRightClickBlock(Minecraft.getMinecraft().player, mc.world, var0, var1, var2, EnumHand.MAIN_HAND);
   }
   ...
   public static void placeBlockScaffold(BlockPos var0) {
      Vec3d var1 = new Vec3d(Minecraft.getMinecraft().player.posX, Minecraft.getMinecraft().player.posY + (double)Minecraft.getMinecraft().player.getEyeHeight(), Minecraft.getMinecraft().player.posZ);
