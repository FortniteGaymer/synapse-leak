...
public class NoFall extends Module {
    ...
    private Value<Integer> distance = addSetting(new Value("Distance", 15, 0, 50, v -> mode.getValue() == Mode.BUCKET));
    private Value<Boolean> glide = addSetting(new Value("Glide", false, v -> mode.getValue() == Mode.ELYTRA));
    private Value<Boolean> silent = addSetting(new Value("Silent", true, v -> mode.getValue() == Mode.ELYTRA));
    private Value<Boolean> bypass = addSetting(new Value("Bypass", false, v -> mode.getValue() == Mode.ELYTRA));
