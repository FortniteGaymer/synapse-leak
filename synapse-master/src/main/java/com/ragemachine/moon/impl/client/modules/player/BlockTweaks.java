...
public class BlockTweaks extends Module {
    ...
    public Value<Boolean> autoTool = addSetting(new Value("AutoTool", false));
    public Value<Boolean> autoWeapon = addSetting(new Value("AutoWeapon", false));
    public Value<Boolean> noFriendAttack = addSetting(new Value("NoFriendAttack", false));
    public Value<Boolean> noBlock = addSetting(new Value("NoHitboxBlock", true));
    public Value<Boolean> noGhost = addSetting(new Value("NoGlitchBlocks", false));
    public Value<Boolean> destroy = addSetting(new Value("Destroy", false, v -> noGhost.getValue()));
    ...
    public void onPacketSend(PacketEvent.Send event) {
        ...
        if(noFriendAttack.getValue() && event.getPacket() instanceof CPacketUseEntity) {
            ...
            if(entity != null && MoonHack.getFriendManager.isFriend(entity.getName())) {
