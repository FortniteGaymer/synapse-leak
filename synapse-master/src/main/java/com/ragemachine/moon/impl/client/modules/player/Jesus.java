...
import com.ragemachine.moon.api.event.events.JesusEvent;
...
public class Jesus extends Module {
    ...
    public Value<Mode> mode = addSetting(new Value("Mode", Mode.NORMAL));
    public Value<Boolean> cancelVehicle = addSetting(new Value("NoVehicle", false));
    public Value<EventMode> eventMode = addSetting(new Value("Jump", EventMode.PRE, v -> mode.getValue() == Mode.TRAMPOLINE));
    public Value<Boolean> fall = addSetting(new Value("NoFall", false, v -> mode.getValue() == Mode.TRAMPOLINE));
